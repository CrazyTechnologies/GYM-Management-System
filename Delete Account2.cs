...
namespace Star_Gym
{
    public partial class Delete_Account2 : Form
    {
        public Delete_Account2()
        {
            InitializeComponent();
        }
        ...
        {
            AccountMenu2 sn = new AccountMenu2();
            sn.Show();
            this.Hide();
        }
        ...
        private void Delete_Account2_Load(object sender, EventArgs e)
        {
            txu.Enabled = true;
            txp.Enabled = true;
            cb.Enabled = false;
